...
function HeroSection() {
    ...
    return (
        <div
            className="h-auto sm:h-[500px] bg-green-500 relative before:bg-gradient-to-r before:from-green-600 before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10">
            ...
            <div className="relative sm:absolute inset-0 px-0 sm:px-8 z-[40] flex items-center">
                <div className="w-full sm:container flex mx-auto justify-between items-center">
                    ...
                    <div className="w-full sm:w-[400px] bg-gray-50 sm:rounded-lg px-5 py-3 pb-5 sm:py-6">
                        <h3 className="text-center mb-4 font-semibold text-green-600">Giriş yap veya kayıt ol</h3>
                        <div className="flex flex-col gap-y-3">
                            <div className="flex gap-x-3">
                                ...
                                <label className="relative flex-1 group">
                                    <input required
                                        className="h-full rounded px-4 pt-2 hover:border-green-700 focus:border-green-700 transition-colors outline-none text-sm w-full border-2 border-gray-200 peer" />
                                    <span
                                        className="absolute top-0 left-0 h-full flex items-center px-4 text-sm text-gray-500 transition-all group-focus-within:h-7 group-focus-within:text-xs group-focus-within:text-green-600 peer-valid:h-7 peer-valid:text-xs peer-valid:text-green-600">
                                        Telefon Numarası
                                    </span>
                                </label>
                            </div>
                            <button className="h-12 rounded-lg transition-colors bg-yellow-300 text-green-700 text-sm font-semibold hover:bg-green-700 hover:text-yellow-300">
